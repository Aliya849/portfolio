...
function Contact() {
  ...
  return (
    <div>
      <section className="min-h-screen bg-black text-white flex flex-col items-center ">
        ...
        <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form className="bg-gray-900 p-6 rounded-2xl shadow-lg" onSubmit={handleSubmit}>
        ...
        <div className="mt-6">
          <Link to="/" className="bg-[#e0b1cb] text-black font-bold py-2 px-8 text-lg rounded-2xl hover:bg-[#be95c4] transition">
            Home
          </Link>
        </div>
      </section>
